...
class PagePage extends StatefulWidget {
  ...
  PagePage({Key key, @required PagesPostBloc pagesPostBloc}) : _pagesPostBloc = pagesPostBloc;
...
class PagePageState extends State<PagePage> {
  ...
  PagePageState({@required PagesPostBloc pagesPostBloc}) : _pagesPostBloc = pagesPostBloc;
              ...
              itemBuilder: (BuildContext context, int index) {
                return Card(
                    ...
                    child: Column(children: <Widget>[
                      ...
                      MarkdownBody(data: html2md.convert(model.results[index].content))
                    ]));
              });
        });
  }
  ...
  Widget _loadingIndicator() {
    return Stack(
      children: <Widget>[
        ...
        Center(
          child: Stack(children: <Widget>[Text("Cargando"), CircularProgressIndicator()]),
        ),
      ],
    );
  }
